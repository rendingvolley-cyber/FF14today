...
assert.match(entry, /category-job-focus-wrapper\.js/);
...
console.log("GC table UI, category focus chain, market fallback chain, and 300-item seal sell-through ranking: ok");
